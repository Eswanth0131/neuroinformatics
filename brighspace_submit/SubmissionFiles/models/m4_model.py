...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=2, in_channels=1):
        """
    ...
    def forward(self, lr_imgs):
        ...
        """
        output = F.interpolate(lr_imgs, size=(179, 221, 200), mode='trilinear')
