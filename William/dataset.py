...
if __name__ == "__main__":
    """
    'python main.py gen' : generate the dataframe from dataset, and save as a pickle file
    'python main.py view {option}' : 
        option=1: to just see 1 low image vs 5 high images, trying to match indices, since image sizes are not the same
        option=2: See images after running throught pytorch dataloader
        option="result": see model output result
